...
public class PendingPropertyFragment extends Fragment implements ResponseCallBack {
    GridView gridView;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.activity_pendin_property_fragment, container, false);
        SharedPreferences prefs = getContext().getSharedPreferences("shared", Context.MODE_PRIVATE);
       propertyService=new PropertyService();
        id = prefs.getInt("id", 0);
        gridView=view.findViewById(R.id.pendingGrid);
        getProperties();
        return view;
    }
    ...
    public void getProperties(){
        propertyService.pendingProperties(this);
    }
    ...
    public void onSuccess(Response response) throws IOException {
        ...
        if(!properties.isEmpty()){
            PropertiesAdapter adapter= new PropertiesAdapter(properties,getContext(),"pending");
