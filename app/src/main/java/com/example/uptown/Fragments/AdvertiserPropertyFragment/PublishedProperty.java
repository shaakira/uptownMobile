...
public class PublishedProperty extends Fragment implements ResponseCallBack {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.activity_published_property, container, false);
        SharedPreferences prefs = getContext().getSharedPreferences("shared", Context.MODE_PRIVATE);
        propertyService = new PropertyService();
        id = prefs.getInt("id", 0);
        gridView = view.findViewById(R.id.pp_Grid);
    ...
    public void getProperties(int advertiserID) {
        propertyService.myPublishedProperties(advertiserID, this);
    }
    ...
    public void onSuccess(Response response) throws IOException {
        ...
        if (!properties.isEmpty()) {
            AdvertiserPropertyAdapter adapter = new AdvertiserPropertyAdapter(properties, getContext(), "published",PublishedProperty.this);
